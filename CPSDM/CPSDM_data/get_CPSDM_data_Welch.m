function [CPSDM] = get_CPSDM_data_Welch(data, CPSDM, N_seg, overlap, window)


%% Description of the function
% 
% This function provides the one-sided CPSDM from a finite multivariate time 
% series, obtained through the Welch method.
%
% The CPSDM is obtained by applying function 'get_S_data_Welch' to the different 
...
for k_i = 1:k
    ...
    for k_j = k_i:k
        ...
        k_index = [k_i k_j];
        [S, ~] = get_S_data_Welch(data, S0, N_seg, overlap, window, k_index);
